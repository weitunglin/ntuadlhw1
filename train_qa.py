...
def main():
    ...
    if args.debug:
        for split in raw_datasets.keys():
            raw_datasets[split] = raw_datasets[split].select(range(50))
    """
    ...
    def prepare_train_features(examples):
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            if args.debug:
                print('examples[answer_column_name][:3]')
                print(examples[answer_column_name][:3])
                print('sample_index')
                print(sample_index)
                print('answers')
            ...
            if False and len(answers["start"]) == 0:
    ...
    eval_examples = raw_datasets["valid"]
